...
CreateDepthTexture(Uint32 drawablew, Uint32 drawableh)
{
    ...
    depthtex_createinfo.level_count = 1;
...
CreateMSAATexture(Uint32 drawablew, Uint32 drawableh)
{
    ...
    msaatex_createinfo.level_count = 1;
...
Render(SDL_Window *window, const int windownum)
{
    ...
    */
    ...
    depth_attachment.depth_stencil_clear_value.depth = 1.0f;
...
load_shader(SDL_bool is_vertex)
{
    ...
    createinfo.sampler_count = 0;
    createinfo.storage_buffer_count = 0;
    createinfo.storage_texture_count = 0;
    createinfo.uniform_buffer_count = is_vertex ? 1 : 0;
    createinfo.props = 0;
...
init_render_state(int msaa)
{
    ...
    color_attachment_desc.blend_state.blend_enable = 0;
    ...
    color_attachment_desc.blend_state.src_alpha_blend_factor = SDL_GPU_BLENDFACTOR_ONE;
    color_attachment_desc.blend_state.dst_alpha_blend_factor = SDL_GPU_BLENDFACTOR_ZERO;
    color_attachment_desc.blend_state.src_color_blend_factor = SDL_GPU_BLENDFACTOR_ONE;
    color_attachment_desc.blend_state.dst_color_blend_factor = SDL_GPU_BLENDFACTOR_ZERO;

    pipelinedesc.attachment_info.color_attachment_count = 1;
    ...
    pipelinedesc.depth_stencil_state.depth_test_enable = 1;
    pipelinedesc.depth_stencil_state.depth_write_enable = 1;
    ...
    pipelinedesc.vertex_input_state.vertex_binding_count = 1;
    pipelinedesc.vertex_input_state.vertex_bindings = &vertex_binding;
    pipelinedesc.vertex_input_state.vertex_attribute_count = 2;
